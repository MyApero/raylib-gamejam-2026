- [ ] merged with ... shouldn't include the id of someone
id is very confidential as it can be used to take the account

- [ ] When launching, the selected color is not in the recent color used

- [ ] You can't paste in "Paste an ID"

- [ ] reset an account should give a random color
...
- [ ] 40FPS with 10 ilots? What's happening already, it should be smoother.
