...
// This was generated using spacetimedb cli version 2.7.0 (commit 903ed9cebff40e389d6087b061f2311e283cb29b).
...
pub use paint_cell_reducer::paint_cell;
...
pub enum Reducer {
    PaintCell { col: u32, row: u32, color: u32 },
    SetName { name: String },
    SetPos { x: f32, y: f32 },
}
...
impl __sdk::Reducer for Reducer {
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::PaintCell { col, row, color } => {
                __sats::bsatn::to_vec(&paint_cell_reducer::PaintCellArgs {
                    col: col.clone(),
                    row: row.clone(),
                    color: color.clone(),
                })
            ...
            Reducer::SetPos { x, y } => __sats::bsatn::to_vec(&set_pos_reducer::SetPosArgs {
                x: x.clone(),
                y: y.clone(),
            }),
            _ => unreachable!(),
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                "cell" => db_update
                    .cell
                    .append(cell_table::parse_table_update(table_update)?),
                "user" => db_update
                    .user
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.cell = cache
            .apply_diff_to_table::<Cell>("cell", &self.cell)
...
pub struct AppliedDiff<'r> {
    cell: __sdk::TableAppliedDiff<'r, Cell>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Cell>("cell", &self.cell, event);
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        cell_table::register_table(client_cache);
        user_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["cell", "user"];
}
